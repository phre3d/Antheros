...
````col
```col-md
Previous: [[Plot/Murder at the Old Wolf Inn/Murder at the Old Wolf Inn|Introduction]]
```

```col-md
textAlign=right
===
Next: [[Plot/Murder at the Old Wolf Inn/Arriving at the Inn|Arriving at the Inn]]
```
````
