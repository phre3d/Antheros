...
===
# Outline
The Chronos Lobby is an opulent entrance to the Clockwork Tower, featuring walls lined with ornate timepieces of all sizes. The main focus is a grand central timepiece that towers over the room. However, it is silent and lifeless, requiring numerous parts for restoration. The clockwork bird guides, [[person/Tick and Tock]], can be found here fluttering around, offering guidance to adventurers willing to listen. The required parts can be discovered in Haven's [[plot/Great Junkyard]], a sprawling wasteland of discarded clockwork and machinery. There, adventurers might face Rust Engineers, ghosts of obsolete workers that were once alive with purpose.

> [!read-aloud] **Read Aloud** 
 >  
 > As you enter the Clockwork Tower, you find yourselves enveloped in the splendor of an opulent space, where it feels as if time has come to a standstill. Walls around you are adorned with countless timepieces, from miniature hourglasses to grandiose mechanical clocks. Every timekeeping device imaginable resides here, each more intricate than the last, yet all frozen in place, emphasizing the room's silence. Dominating the heart of the room is a colossal central timepiece that stretches from floor to ceiling - its magnificent potential clear; yet for now, it remains silent and dormant.
 > 
 ...
 **Grand Central Timepiece:**  A giant ornamental clock, currently non-functional. Restoring it might be key to helping reactivate the Clockwork Tower. Parts required for its restoration can be found in Haven's [[plot/Great Junkyard]].
...
The easiest way to picture the Tower interior is to imagine each room is on a separate level with a stairway between them that twists time and space. 
...
- **Tick:**   "Chirp-chirp! The L-Lobby door, where time does snore! Needs p-p-pieces from junkyard floor!"
- **Tock:**   "Tock-tock! In the j-j-junkyard lore, find what the clock does implore!"

 **Regarding the [[plot/Gear Foundry]]:** 
 ...
 **Regarding the Assembly Room:** 
- **Tick:**   "Chirp-chirp! O-O-Olivia knows, how to fix, where it goes!"
- **Tock:**   "Tock-tock! Sprites play tricks, on the way to Olivia's mix!"

 **Regarding the [[plot/Artificer's Library]]:** 
- **Tick:**   "Chirp-chirp! Cogsprocket Sp-sp-spiders lurk, guarding knowledge, their tireless work!"
- **Tock:**   "Tock-tock! Mind where you s-s-step, or in spiders' web, you might get swept!"

 **Regarding the [[plot/Timepiece of Eternity]] Room:** 
- **Tick:**   "Chirp-chirp! The p-p-pedestal's hollow call, seeks a crystal, to rise, not fall!"
- **Tock:**   "Tock-tock! [[plot/Luminous Caverns]] gleam, but Pendulum Horrors lurk and scheme!"

 **Regarding the [[plot/Echo Chamber]]:** 
- **Tick:**   "Chirp-chirp! Echoes broken, mirrors lost! Mayor Elspeth knows the cost!"
- **Tock:**   "Tock-tock! Phantoms of P-p-paradox play, in [[plot/Council Chambers]], causing disarray!"
...
Below is a list of parts needed to restore the Grand Central Timepiece. They can be found in the [[plot/Great Junkyard]].
...
On initiative count 20 (losing initiative ties), the Clockwork Tower activates a defense. The tower uses a random defense , or the DM can choose one.
...
# Monster 
![[1409110]]|Clockwork Sentinal
![[1409069]]|Clockwork Guardian

# NPC 
[[person/Tick and Tock]]
...
**Id:** 50f71366-e513-49e2-8758-c82cf2ea30d9<br>
