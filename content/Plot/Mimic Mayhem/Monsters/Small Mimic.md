...
>[!infobox]
>![[Plot/Mimic Mayhem/Images/tkn.Chimney Mimic (Small).png]]
>![[Plot/Mimic Mayhem/Images/tkn.Dartboard Mimic (Small).png]]
>![[Plot/Mimic Mayhem/Images/tkn.Sign Mimic (Small).png]]
>![[Plot/Mimic Mayhem/Images/tkn.Window Mimic (Small).png]]
...
*Hit:* 5 (1d6 + 2) bludgeoning damage <mark style="background:#d3f8b6">and grappled. A Pseudopod that is already grappling someone does not attack again but instead tries to pull their victim ten feet closer by winning an opposed Athletics check.</mark>
