...
>[!infobox]
>![[Plot/Burgled Budgie/Images/Herbert Spillwyrt.webp]]
>(AI created)
...
**Damage Resistances:** damage from spells<br>
...
- **2nd level** (3 slots): *invisibility, misty step, web*<br><br>

- **3rd level** (3 slots): *counterspell, fly, lightning bolt*<br><br>

- **4th level** (3 slots): *confusion, polymorph, stoneskin*<br><br>

- **5th level** (3 slots): *animate objects, conjure elemental, scrying*<br><br>

- **6th level** (1 slot): *wall of ice*<br><br>

- **7th level** (1 slot): *mirage arcane*<br><br>

- **8th level** (1 slot): *dominate monster*<br><br>
