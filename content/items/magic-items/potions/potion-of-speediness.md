...
## Effects
Fills the body with tremendous energy and allows the imbiber to double the number of attacks per round with no ill effects when the potion wears off one minute later.
