...
## Effects
Allows the imbiber to calculate angles when working with a slingshot. 

If an attack is successful, the ammunition can bounce to another target within 10'. If it hits, it can bounce again and keep repeating this action until an attack misses or there are no other creatures within 10'. 

Note: This cascade of attacks can strike targets more than once. The attacker makes an attack roll for each bounce and rolls damage separately for each successful strike.
