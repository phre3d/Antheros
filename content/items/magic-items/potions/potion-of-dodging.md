...
Grants superior hand-eye coordination. As a reaction, once per round for a minute, the imbiber can attempt to block a melee or range attack. The blocking effect boosts AC by four against that one attack.
