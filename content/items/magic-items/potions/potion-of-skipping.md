...
Allows the imbiber to teleport anywhere that can be seen - either with the naked eye or with a telescope or similar device.

The potion should only be used when one has a clear view and focus on the new location, as trying to teleport to a place that cannot be seen clearly can cause danger or even death.

Once per round, the imbiber teleports to the viewed location as a bonus action.
