...
The imbiber is surrounded by a 5' aura. Any non-magical iron-based object (other than on the imbiber) that enters the aura immediately begins rusting. If not treated immediately, it will rust completely away in 1d4+2 rounds.

Each round an item is affected, it loses one level of effectiveness. For example, a sword would become a -1 sword after one round, and plate armor would drop to AC 17 after the first round, etc.
