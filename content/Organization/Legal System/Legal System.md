...
For additional detail, refer to [[Organization/Legal System/Judges in Haven|Judges in Haven]].
...
For additional detail, refer to [[Organization/Legal System/Lawyers in Haven|Lawyers in Haven]].

## Conducting the Trial 
Basically, to determine the outcome of a trial you roll d100, adjust for the various modifiers and look up the results on that judge's decision table. There are however some differences between a criminal and a civil trial. For details, refer to [[article/Factors Affecting Trials |Factors Affecting Trials ]].
...
4. Add judge bribery modifier
5. +15% if the client is actually innocent
6. Add any other modifier appropriate (role playing, etc.)
7. Look up the resulting total on that judge's decision table.
...
4. +25% for whichever side has "Right on one's side" if that applies
5. Add any other modifiers the GM feels are appropriate
6. The decision roll Target = Plaintiff total / (Plaintiff total + Defendant total)
7. Roll d100 1d100 and if less than or equal to the target the plaintiff wins
